...
import { arInvoicesAPI, customersAPI, currenciesAPI, taxRatesAPI } from '../../../../../services/api';
import { ARInvoiceItem, Customer, Currency, TaxRate } from '../../../../../types';
import { Plus, Trash2 } from 'lucide-react';
import toast from 'react-hot-toast';

export default function EditARInvoicePage() {
  ...
  const fetchInitialData = async () => {
    try {
      ...
      // Fetch customers, currencies, and invoice data in parallel
      const [customersRes, currenciesRes, invoiceRes] = await Promise.all([
        customersAPI.list(),
        currenciesAPI.list(),
        arInvoicesAPI.get(parseInt(invoiceId))
      ]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await arInvoicesAPI.update(parseInt(invoiceId), invoiceData as any);
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900">Edit AR Invoice</h1>
